 ...
 *    Maximum Number of Balls in a Box</a>
 * @author zms
 * @date 11:45 上午 2021/2/1
 */
public class MaximumNumberOfBallsInABox {
     ...
     * the ball number 321 will be put in the box number 3 + 2 + 1 = 6
