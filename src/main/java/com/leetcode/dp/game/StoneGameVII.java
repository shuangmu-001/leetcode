 ...
 * TODO <a href="https://leetcode.com/problems/stone-game-vii/">
 * Stone Game VII</a>
 */
public class StoneGameVII {
    ...
    public static void main(String[] args) {
        System.out.println(stoneGameVII(new int[]{5, 3, 1}) == 3);
        System.out.println(stoneGameVII(new int[]{5, 3, 1, 4, 2}) == 6);
    }
