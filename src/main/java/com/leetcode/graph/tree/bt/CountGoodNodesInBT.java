...
public class CountGoodNodesInBT {
     ...
     * Root TreeNode (3) is always a good node.
     * TreeNode 4 -> (3,4) is the maximum value in the path starting from the root.
     * TreeNode 5 -> (3,4,5) is the maximum value in the path
     * TreeNode 3 -> (3,1,3) is the maximum value in the path.
     * Example 2:
     *
     *
     *
     ...
     * Output: 3
     * Explanation: TreeNode 2 -> (3, 3, 2) is not good, because "3" is higher than it.
     * Example 3:
     *
     * Input: root = [1]
     * Output: 1
